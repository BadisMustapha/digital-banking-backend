...
import org.badis.digitbankbackend.services.IBankAccountService;
        ...
        return args -> {
           //bankService.consulter();
            ...
            bankAccountService.listCustomers().forEach(customer->{
                try {
                    bankAccountService.saveCurrentBankAccount(Math.random()*30000,9000,customer.getId());
                    bankAccountService.saveSavingBankAccount(Math.random()*120000,4.7,customer.getId());
